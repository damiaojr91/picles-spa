...
function ForwardedPictureUpload({ value, onChange }: PictureUploadProps, ref: Ref<HTMLInputElement>) {
  ...
  return (
    <>
      <input ref={ref} id="photo-upload" className={styles.hiddenInput} type="file" accept="image/*" onChange={handleChange} />
